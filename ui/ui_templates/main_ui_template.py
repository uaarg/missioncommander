...
class Ui_mainWindow(object):
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "Mission Commander"))
        self.interopFreqDisplay.setText(_translate("mainWindow", "Field - To be populated"))
        self.ivyMessageTSLabel.setText(_translate("mainWindow", "Last Ivy Message Timestamp"))
        self.ivyMessageTSDisplay.setText(_translate("mainWindow", "Field - To be populated"))
        self.interopFreqDisplay_2.setText(_translate("mainWindow", "Current Interoperability Frequency (Hz)"))
        self.derouteButton.setText(_translate("mainWindow", "Quick Deroute"))
        self.sendWaypointButton.setText(_translate("mainWindow", "Send Waypoint"))
        self.typeComboBox.setItemText(0, _translate("mainWindow", "Path"))
        self.typeComboBox.setItemText(1, _translate("mainWindow", "Circle"))
        self.uasWaypointsLabel.setText(_translate("mainWindow", "Last UAS Waypoints"))
        self.unstagedLabel.setText(_translate("mainWindow", "Unstaged Waypoints"))
        self.stagedLabel.setText(_translate("mainWindow", "Staged Waypoints"))
        self.replaceAllButton.setText(_translate("mainWindow", "Replace All"))
        self.prependButton.setText(_translate("mainWindow", "Prepend"))
        self.replaceButton.setText(_translate("mainWindow", "Replace"))
        self.appendButton.setText(_translate("mainWindow", "Append"))
        ...
        self.actionClose.setText(_translate("mainWindow", "Open Project"))
        self.actionImport.setText(_translate("mainWindow", "Save Project"))
        self.actionClose_2.setText(_translate("mainWindow", "Import Project"))
